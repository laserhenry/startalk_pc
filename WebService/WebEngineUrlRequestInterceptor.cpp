...
WebEngineUrlRequestInterceptor::WebEngineUrlRequestInterceptor(WebView* webView, QObject* o)
    :QWebEngineUrlRequestInterceptor(o)
{
    pWebview = webView;
}
...
//    }
//
//    qInfo() << "RequestMethod:" << info.requestMethod() << "\n"
//             << "RequestUrl:" << info.requestUrl() << "\n"
//             << "RequestType:" << strInfo <<"\n";

    qInfo() << info.requestUrl();
}